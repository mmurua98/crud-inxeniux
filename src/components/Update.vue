                            ...
                            <div class="row primerRow">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apellido_paterno" id="apellido_paterno" v-model="usuario.apellido_paterno" class="form-control" placeholder="Apellido paterno" aria-describedby="Apellido paterno" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        <label for="">Apellido Materno</label>
                                        <input type="text" name="apellido_materno" id="apellido_materno" v-model="usuario.apellido_materno" class="form-control" placeholder="Apellido materno" aria-describedby="Apellido materno" required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo_postal" id="codigo_postal" v-model="usuario.codigo_postal" class="form-control" placeholder="Código postal" aria-describedby="Código postal" required>
                            </div>
                        </div>
                     </div>
                </div>
...
export default {
    ...
    methods:{
        ...
        getDataById(){
            fetch('http://localhost/api-inxenius/?consultar='+this.$route.params.id)
        ...
        updateUsuario(){
            ...
            fetch('http://localhost/api-inxenius/?actualizar='+this.$route.params.id,{
                method:"POST",
